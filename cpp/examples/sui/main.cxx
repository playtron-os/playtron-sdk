#include <playtron/sdk/sui.hxx>
#include <iostream>
#include <string>
#include <limits>

using namespace playtron::sdk::sui;
    ...
    while (true) {
        ...
        if (choice == '1') {
            ...
            try {
                ...
                SignResult res = sign_message("", msg);
            ...
            std::string txBytes = "AAACACC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAAIAOH1BQAAAAACAgABAQEAAQECAAABAAC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAAAAAAAAAAAAAAAAAAAAAAA";

            try {
                // Provider app id is required and should be from the currently running app
                SignResult res = sign_transaction("", txBytes);
            ...
            // Sign & execute transaction flow
            std::cout << "Building transaction and sending for signing and execution\n";
            // TODO: Add transaction building in the example
            std::string txBytes = "AAACACC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAAIAOH1BQAAAAACAgABAQEAAQECAAABAAC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAC4YqsCgHqFRm2YvGd9hP/OtYx4ZP07KfiF0Enx98MMRAAAAAAAAAAAAAAAAAAAAAAA";
