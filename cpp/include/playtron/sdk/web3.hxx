#ifndef PLAYTRON_SDK_WEB3_H
#define PLAYTRON_SDK_WEB3_H
...
namespace playtron
{
    namespace sdk
    {
        namespace web3
        {
             ...
             */
            PLAYTRONAPI MessageResult sign_message(const std::string& providerAppId, const std::string& msg);
